...
```javascript
{
  ...
  // DCV Infrastructure
  dcvConnectionGatewayEndpoint: "dcv-usw2.example.com",
...
interface RegionalHubConfig {
  ...
  // DCV Configuration
  dcvDomainName?: string;            // Custom domain (e.g., "dcv-usw2.example.com")
...
POST /regions
{
  ...
  "dcvDomainName": "dcv-usw2.example.com",
...
// Response
{
  ...
  "data": [
    ...
    },
    {
      ...
      "status": "available",
      "isPrimary": false,
      "dcvEndpoint": "dcv-usw2.example.com",
      "workstationCount": 5
    }
  ]
}
